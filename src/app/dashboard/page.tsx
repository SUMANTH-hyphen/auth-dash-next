                    ...
                    <div className="flex flex-wrap justify-between items-center">
                        ...
                        <div className="flex items-center lg:order-2">
                            ...
                            <div className="relative">
                                <button onClick={()=> setButton((prev)=> !prev)} type="button" className="inline-flex items-center gap-x-1 text-sm font-semibold leading-6 text-gray-900" aria-expanded="false">
                                ...
                                {
                                    button && (
                                        <div className="absolute -left-8 mt-2 flex w-fit -translate-x-9 mr-10 rounded-xl bg-white text-sm flex-auto shadow-lg">
                                            <button onClick={() => signOut()} className="flex items-center p-3">
                                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0 0 48 48" fill="#4285F4" >
                                                    <path
                                                        fill="#4285F4"
                                                ...
                                                <span className="flex-1 ml-3 text-gray-800 whitespace-nowrap">Logout</span>
                                            </button>
                                        </div>
                                    )
                                }
